...
RUN_NAME     = "Picoscope_Oszi_Tool_Export"   # muss zum Messlauf passen (CSV + meta.json)
...
# ===================== CONTROL =====================
AUTO_YLIM    = True     # True: dynamisch nach Daten; False: voller Messbereich
YLIM_PAD     = 0.1      # relativer Puffer (z. B. 0.1 = 10 %)
# ===================================================
