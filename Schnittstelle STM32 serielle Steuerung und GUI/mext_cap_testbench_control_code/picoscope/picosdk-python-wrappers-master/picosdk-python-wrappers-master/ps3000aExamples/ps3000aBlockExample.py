...
status["setChA"] = ps.ps3000aSetChannel(chandle, 
                                        0, # channel A = 0, Channel B = 1, etc. 
                                        1, # enabled = 1 , means channel is on
                                        0, # coupling type = ps3000A_AC = 0, ps3000A_DC = 1
                                        chARange, # range = ps3000A_10V = 8, ps3000A_5V = 7 etc.
...
# Handle = Chandle
# Enable = 1 (ON)
# Source = ps3000_EXTERNAL = 4
# Threshold = 1,5/20 bei +-20V Bereich mit 16 Bit
# Direction = ps3000A_Rising = 0
# Delay = 0
# autoTrigger_ms = 0 = kein Auto-Trigger
V_trigger = 1.5  # Volt
V_fullscale = 10.0  # Volt (bei V_RANGE = PS3000A_10V)
maxADC = 65535  # 2^16/2 - 1
counts = (V_trigger / V_fullscale) * maxADC
status["trigger"] = ps.ps3000aSetSimpleTrigger(chandle, # handle
                                               1, # enable = 1 (ON), means trigger is set
                                               ps.PS3000A_CHANNEL["PS3000A_CHANNEL_A"], # source = ps3000_EXTERNAL = 4
                                               counts, # threshold in ADC counts
                                               picoEnum.PS3000A_THRESHOLD_DIRECTION["PS3000A_RISING"], # direction = ps3000A_Rising = 0
                                               0, # delay = 0
                                               0  # autoTrigger_ms = 0 = kein Auto-Trigger
                                               )
